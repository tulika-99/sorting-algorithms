// Java Program to illustrate Tag Sort. This code uses Bubble Sort to modify tag array according to salaries.
// We can use other optimized sorting techniques also.
class Person
{
	private int id;
...
public class Main
{
	...
	// Modifying tag array so that we can access persons in sorted order of salary.
